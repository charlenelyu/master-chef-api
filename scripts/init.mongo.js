...
const recipeData = [
  {
    ...
    ingrediants: ['olive oil', 'green bell pepper', 'yellow onion', 'salt', 'pepper', 'chicken', 'heavy cream', 'buffalo', 'blue cheese', 'cheez whiz', 'rolls', 'green onion', 'parsley'],
  ...
  },
  {
    ...
    ingrediants: ['jumbo shrimp', 'salt & freshly ground black pepper', 'olive oil', 'fennel bulb', 'garlic cloves', 'crushed red pepper flakes', 'orzo pasta', 'chickpeas', 'cherry tomatoes', 'kalamata olive', 'dill', 'lemon, zest of', 'dry white wine', 'low sodium chicken broth', 'feta'],
  ...
  },
  {
    ...
    ingrediants: ['oats', 'whole wheat flour', 'cocoa powder', 'milk', 'honey', 'butter'],
  ...
  },
  {
    ...
    ingrediants: ['bacon', 'puff pastry', 'eggs', 'sharp cheddar cheese', 'egg', 'water', 'salt and pepper'],
  ...
  },
  {
    ...
    ingrediants: ['coconut milk', 'eggs', 'fresh corn kernels', 'parmesan cheese', 'bacon', 'large shrimp', 'all-purpose flour', 'egg', 'yellow cornmeal', 'panko breadcrumbs', 'coconut oil', 'unsweetened flaked coconut', 'tomato ketchup', 'worcestershire sauce', 'lemon juice', 'soy sauce', 'tabasco sauce'],
  ...
  },
  {
    ...
    ingrediants: ['cauliflower', 'red onion', 'cilantro', 'cumin', 'salt', 'jalapeno', 'limes', 'tortilla chips'],
  ...
  },
  {
    ...
    ingrediants: ['pizza dough', 'butter', 'garlic cloves', 'panko breadcrumbs', 'sweetened flaked coconut', 'eggs', 'small shrimp', 'canola oil', 'mozzarella cheese', 'red fresno chile', 'pineapple', 'red onion', 'scallions', 'kosher salt', 'ground black pepper'],
  ...
  },
  {
    ...
    ingrediants: ['baguette', 'unsalted butter', 'garlic', 'parmesan cheese', 'red chili pepper flakes', 'dry white wine', 'small shrimp', 'cream cheese', 'parsley'],
  ...
  },
  {
    ...
    ingrediants: ['yogurt', 'fresh lemon juice', 'kosher salt', 'garlic cloves', 'tomato paste', 'ground cinnamon', 'ground cumin', 'paprika', 'ground beef', 'extra virgin olive oil', 'red onion', 'all-purpose flour', 'pizza dough', 'cornmeal', 'persian cucumbers', 'cilantro leaf', 'vegetable oil'],
  ...
  },
  {
    ...
    ingrediants: ['short-grain rice', 'salmon', 'salt', 'green onion', 'toasted sesame seeds', 'light soy sauce', 'toasted sesame oil', 'rice vinegar', 'chili sauce', 'avocado', 'greens', 'pickled daikon'],
  ...
  },
  {
    ...
    ingrediants: ['pasta', 'panko breadcrumbs', 'butter', 'cream cheese', 'egg', 'parmesan cheese', 'bacon', 'eggs', 'egg yolk', 'seasoning'],
